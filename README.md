...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-core" % "0.3.2"
```

- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-core_2.11/0.3.2/msgpack4z-core_2.11-0.3.2-sxr.jar/!/index.html)

### snapshot version

```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-core" % "0.3.3-SNAPSHOT"

resolvers += Opts.resolver.sonatypeSnapshots
```

- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/msgpack4z-core_2.11/0.3.3-SNAPSHOT/msgpack4z-core_2.11-0.3.3-SNAPSHOT-sxr.jar/!/index.html)
